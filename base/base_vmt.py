class Base(object):
    ...
    def print_green(self, s):
        return self.color_str(self._green, s)

    def print_yellow(self, s):
        return self.color_str(self._yellow, s)

    def print_blue(self, s):
        return self.color_str(self._blue, s)

    def print_fuchsia(self, s):
        return self.color_str(self._fuchsia, s)

    def print_cyan(self, s):
        return self.color_str(self._cyan, s)

    def print_white(self, s):
        return self.color_str(self._white, s)
